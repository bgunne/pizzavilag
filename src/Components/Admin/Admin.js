...
class Admin extends Component
{
    ...
    uploadPizza()
    {
        ...
        .then(response => response.json())
        .then(setTimeout(() => {this.setState(initialState)}, 100))
        ...
        {            
            return(
                <div className="ma-auto flex tc items-center">
                        <PizzaEditor onFileInputChangeHandler={this.onFileInputChangeHandler} pizza={[]} onFormChange={this.onFormChange}/>
                        <div className="self-end pa1 h-auto" style={{height: "100px", width: "16%", marginLeft: "0", marginRight: "0"}}>
                            ...
                            <p className="f6 grow no-underline br-pill ph3 pv2 dib white pointer ba bw0 bg-dark-red mh1" 
    ...
    render()
    {
        ...
        return(
            <div className="w-80 flex items-center center">
                    ...
                    <li className="ph3 pv3 bb b--light-silver flex tc items-center bg-light-yellow" style={{boxSizing: "content-box"}} key="0">
                        {this.addBar()}
                    </li>
                    {
                        pizzas.map((pizza,i) =>
                        {
                            ...
                            {
                                return(
                                    <li className="ph3 pv3 bb b--light-silver flex tc items-center bg-light-yellow" style={{boxSizing: "content-box"}} key={pizza.id}>
                                        
                                        <PizzaEditor onFileInputChangeHandler={this.onFileInputChangeHandler} pizza={pizza} onFormChange={this.onFormChange}/>
                                        <div className="w-10 pa1 h-auto flex tc items-center center" style={{height: "100px", width: "16%", marginLeft: "0", marginRight: "0"}}>
                            ...
                            {
                                return(
                                    <li className="ph3 pv3 bb b--light-silver flex tc items-center" style={{boxSizing: "content-box", backgroundColor: "#c4954f"}} key={pizza.id}>
                                        <div className=" ma-auto flex tc items-center center" style={{height: "100px", width: "16%"}}>
                                        ...
                                        <div className=" ma-auto flex tc items-center center" style={{height: "100px", width: "16%"}}>
                                            <p className="w-100 center mt-auto mb-auto"><img src={pizza.imageurl} alt={pizza.imageurl} className="db br2 br--top" style={{objectFit:"cover", width: "200px", height:"100px"}} /></p>
                                        </div>
